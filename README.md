...
* Mediafire links (can also fetch from Embedupload), Rapidshare links, Uptobox links, 2Shared links, 180Upload links, 4Shared links, ZOMG Upload links, Zippyshare links, Depositfiles links
